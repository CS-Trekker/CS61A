...
class ProfessorCard(Card):
    ...
    def effect(self, other_card, player, opponent):
        ...
        "*** YOUR CODE HERE ***"
        for player_deck_card in player.deck.cards:
            player_deck_card.attack += other_card.attack
            player_deck_card.defense += other_card.defense
            
        opponent.deck.cards = list(filter(lambda opponet_deck_card: opponet_deck_card.attack != other_card.attack or opponet_deck_card.defense != other_card.defense, opponent.deck.cards))                
